      ...
      <section className="mb-24 text-center px-margin-mobile md:px-margin-desktop bg-surface-container-low py-20 border-b border-outline-variant">
        <div className="max-w-container-max mx-auto">
          ...
          <p className="font-body-lg text-body-lg text-on-surface-variant max-w-3xl mx-auto">
            Solusi profesional untuk perbaikan perangkat keras Anda. Kami berdedikasi untuk memulihkan kinerja optimal elektronik esensial Anda dengan presisi teknis.
          </p>
        </div>
      </section>
        ...
        <section className="mb-24 grid grid-cols-1 md:grid-cols-12 gap-gutter text-left">
          <div className="md:col-span-7 bg-surface-container-lowest p-8 md:p-12 border border-outline-variant rounded-xl flex flex-col justify-center">
            ...
            <p className="mb-4 text-on-surface-variant">
              Pytafix dengan bangga merupakan bagian dari <strong className="text-on-surface">Pyta Group</strong>, ekosistem teknologi terkemuka yang juga menaungi inovator industri, <strong className="text-on-surface">Pytagotech</strong>.
            </p>
            <p className="text-on-surface-variant">
              Dukungan dari ekosistem ini memungkinkan kami mengadopsi standar perbaikan korporat, memastikan setiap prosedur diagnostik dan perbaikan memenuhi kriteria keandalan tertinggi, bukan sekadar solusi sementara.
            </p>
          </div>
