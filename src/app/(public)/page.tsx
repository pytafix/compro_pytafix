      ...
      <section className="bg-primary/5 py-16 md:py-24 border-y border-outline-variant relative overflow-hidden">
        ...
        <div className="max-w-container-max mx-auto px-4 md:px-8 lg:px-margin-desktop">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            >
              <div className="absolute top-4 right-4 bg-error text-on-error font-label-sm px-3 py-1 rounded-full text-xs font-bold tracking-wider">TERBATAS</div>
              ...
              <h3 className="font-headline-sm text-headline-sm text-on-surface mb-2">Diskon Mahasiswa 20%</h3>
              <p className="font-body-md text-body-md text-on-surface-variant mb-6 flex-grow">
                Tunjukkan KTM aktif Anda dan nikmati potongan 20% untuk jasa servis laptop & smartphone.
              </p>
              <Link href="/promo" className="w-full text-center bg-surface-container-low text-primary font-label-bold py-3 rounded hover:bg-primary hover:text-on-primary transition-colors border border-outline-variant group-hover:border-primary">
                Klaim Promo
              </Link>
            </motion.div>
            ...
            <motion.div 
              ...
              className="bg-surface rounded-2xl border border-outline-variant p-6 hover:shadow-lg transition-all group relative overflow-hidden flex flex-col"
            >
              <div className="absolute top-4 right-4 bg-tertiary text-on-tertiary font-label-sm px-3 py-1 rounded-full text-xs font-bold tracking-wider">BARU</div>
              <div className="w-16 h-16 bg-tertiary/10 rounded-2xl flex items-center justify-center mb-6 text-tertiary group-hover:scale-110 group-hover:bg-tertiary group-hover:text-on-tertiary transition-all duration-300">
                <span className="material-symbols-outlined text-3xl" aria-hidden="true">cached</span>
              </div>
              <h3 className="font-headline-sm text-headline-sm text-on-surface mb-2">Cashback Ganti LCD</h3>
              <p className="font-body-md text-body-md text-on-surface-variant mb-6 flex-grow">
                Dapatkan cashback hingga Rp 100.000 untuk pergantian LCD iPhone original. Garansi 3 bulan.
              </p>
              <Link href="/promo" className="w-full text-center bg-surface-container-low text-primary font-label-bold py-3 rounded hover:bg-primary hover:text-on-primary transition-colors border border-outline-variant group-hover:border-primary">
                Klaim Promo
              </Link>
            ...
            <motion.div 
              ...
              className="bg-surface rounded-2xl border border-outline-variant p-6 hover:shadow-lg transition-all group relative overflow-hidden flex flex-col md:hidden lg:flex"
            >
              <div className="w-16 h-16 bg-secondary/10 rounded-2xl flex items-center justify-center mb-6 text-secondary group-hover:scale-110 group-hover:bg-secondary group-hover:text-on-secondary transition-all duration-300">
                <span className="material-symbols-outlined text-3xl" aria-hidden="true">cleaning_services</span>
              </div>
              <h3 className="font-headline-sm text-headline-sm text-on-surface mb-2">Gratis Cleaning Laptop</h3>
              <p className="font-body-md text-body-md text-on-surface-variant mb-6 flex-grow">
                Promo akhir pekan! Gratis pembersihan kipas dan ganti pasta thermal untuk setiap perbaikan motherboard.
              </p>
              <Link href="/promo" className="w-full text-center bg-surface-container-low text-primary font-label-bold py-3 rounded hover:bg-primary hover:text-on-primary transition-colors border border-outline-variant group-hover:border-primary">
                Klaim Promo
              </Link>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
            ...
            >
              <div className="aspect-square bg-surface-container-low p-6 flex items-center justify-center relative">
                <div className="absolute top-3 right-3 bg-surface text-on-surface font-label-sm text-xs px-2 py-1 rounded-md border border-outline-variant shadow-sm z-10">Baterai</div>
                <div className="w-full h-full relative group-hover:scale-105 transition-transform duration-500">
                  <Image src="https://images.unsplash.com/photo-1603539843394-b2203bf4db24?w=500&auto=format&fit=crop&q=80" alt="Baterai Laptop" fill className="object-cover rounded-xl" />
                </div>
              </div>
              <div className="p-4 md:p-5 flex flex-col flex-grow">
                <h3 className="font-label-bold text-label-bold text-on-surface mb-1 line-clamp-2">Baterai Laptop Asus Original OEM</h3>
                <p className="font-body-sm text-body-sm text-on-surface-variant mb-4">Garansi 6 Bulan</p>
                <div className="mt-auto flex flex-col gap-3">
                  <p className="font-headline-sm text-headline-sm text-primary">Rp 450.000</p>
            ...
            >
              <div className="aspect-square bg-surface-container-low p-6 flex items-center justify-center relative">
                <div className="absolute top-3 right-3 bg-surface text-on-surface font-label-sm text-xs px-2 py-1 rounded-md border border-outline-variant shadow-sm z-10">Layar LCD</div>
                <div className="w-full h-full relative group-hover:scale-105 transition-transform duration-500">
                  <Image src="https://images.unsplash.com/photo-1592505295719-74e9bd103986?w=500&auto=format&fit=crop&q=80" alt="LCD iPhone" fill className="object-cover rounded-xl" />
                </div>
              </div>
              <div className="p-4 md:p-5 flex flex-col flex-grow">
                <h3 className="font-label-bold text-label-bold text-on-surface mb-1 line-clamp-2">Layar LCD iPhone 13 Pro Max</h3>
                <p className="font-body-sm text-body-sm text-on-surface-variant mb-4">Garansi 3 Bulan + True Tone</p>
                <div className="mt-auto flex flex-col gap-3">
                  <p className="font-headline-sm text-headline-sm text-primary">Rp 2.150.000</p>
                  <Link href="/sparepart" className="w-full py-2 bg-surface text-on-surface border border-outline font-label-bold text-center rounded hover:bg-primary hover:text-on-primary hover:border-primary transition-colors text-sm">
                    Pesan Pasang
                  </Link>
                </div>
            ...
            >
              <div className="aspect-square bg-surface-container-low p-6 flex items-center justify-center relative">
                <div className="absolute top-3 right-3 bg-surface text-on-surface font-label-sm text-xs px-2 py-1 rounded-md border border-outline-variant shadow-sm z-10">RAM/SSD</div>
                <div className="w-full h-full relative group-hover:scale-105 transition-transform duration-500">
                  <Image src="https://images.unsplash.com/photo-1591488320449-011701bb6704?w=500&auto=format&fit=crop&q=80" alt="RAM Laptop" fill className="object-cover rounded-xl" />
                </div>
              </div>
              <div className="p-4 md:p-5 flex flex-col flex-grow">
                <h3 className="font-label-bold text-label-bold text-on-surface mb-1 line-clamp-2">RAM 16GB DDR4 Kingston Fury</h3>
                <p className="font-body-sm text-body-sm text-on-surface-variant mb-4">Garansi Lifetime</p>
                <div className="mt-auto flex flex-col gap-3">
                  <p className="font-headline-sm text-headline-sm text-primary">Rp 650.000</p>
                  <Link href="/sparepart" className="w-full py-2 bg-surface text-on-surface border border-outline font-label-bold text-center rounded hover:bg-primary hover:text-on-primary hover:border-primary transition-colors text-sm">
                    Pesan Pasang
                  </Link>
                </div>
            ...
            >
              <div className="aspect-square bg-surface-container-low p-6 flex items-center justify-center relative">
                <div className="absolute top-3 right-3 bg-surface text-on-surface font-label-sm text-xs px-2 py-1 rounded-md border border-outline-variant shadow-sm z-10">Konektor</div>
                <div className="w-full h-full relative group-hover:scale-105 transition-transform duration-500">
                  <Image src="https://images.unsplash.com/photo-1558227691-41ea78d1f631?w=500&auto=format&fit=crop&q=80" alt="Konektor Charger" fill className="object-cover rounded-xl" />
                </div>
              </div>
              <div className="p-4 md:p-5 flex flex-col flex-grow">
                <h3 className="font-label-bold text-label-bold text-on-surface mb-1 line-clamp-2">Port Charger Type-C Samsung</h3>
                <p className="font-body-sm text-body-sm text-on-surface-variant mb-4">Pengerjaan 1 Jam</p>
                <div className="mt-auto flex flex-col gap-3">
                  <p className="font-headline-sm text-headline-sm text-primary">Rp 150.000</p>
                  <Link href="/sparepart" className="w-full py-2 bg-surface text-on-surface border border-outline font-label-bold text-center rounded hover:bg-primary hover:text-on-primary hover:border-primary transition-colors text-sm">
                    Pesan Pasang
                  </Link>
                </div>
